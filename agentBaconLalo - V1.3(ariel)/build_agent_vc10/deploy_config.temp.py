...
config = {}
cmdline = ['c:/Marmalade/6.2/s3e/makefile_builder/mkb.py', '--use-temp-extension', '--verbose=1', 'c:/Users/ironwk/Documents/blackberry/juego/agentBaconLalo - V1.3(ariel)/Agent.mkb', '--default-buildenv=vc10', '--msvc-project', '--deploy-only']
