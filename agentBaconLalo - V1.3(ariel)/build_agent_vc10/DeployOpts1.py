...
options["cmdline"]=['C:/Marmalade/6.2/s3e/makefile_builder/mkb.py', 'c:/Users/ironwk/Documents/blackberry/juego/agentBaconLalo - V1.3(ariel)/Agent.mkb', '--default-buildenv=vc10', '--msvc-project', '--deploy-only']
options["configlist"]=ur'Default ,'
options["deploymode"]=ur'Package and Install'
